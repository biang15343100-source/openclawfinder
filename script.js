const translations = {
  en: {
    ...
    home: {
      ...
      heroLead:
        "A curated directory of OpenClaw variants, tools, and ecosystem projects, so you can quickly see what exists and where each one fits.",
      ...
      directoryLead:
        "Start with the main projects and tools people most often compare first, with links pointing to official sites, docs, or repositories whenever possible.",
      ...
      ctaBody:
        "Send your project name, link, and a short summary through the submission page, and we can review it for inclusion.",
      ctaButton: "Submit now",
      footerText: "A directory for discovering OpenClaw projects and ecosystem tools.",
    },
    about: {
  ...
  zh: {
    ...
    home: {
      ...
      heroTitle:
        "<span class=\"hero-title-accent\">OpenClaw</span><span class=\"hero-title-emoji\">🦞</span><span class=\"hero-title-accent\">Finder</span>",
      heroLead:
        "把 OpenClaw 的变体、工具和生态项目收在一起，帮你更快看清现在有哪些选择、各自适合什么场景。",
      browse: "浏览目录",
      submit: "提交项目",
      profileLink: "详情",
      cardMetaAngle: "定位",
      ...
      directoryTitle: "先看这些",
      directoryLead: "先从大家最常比较的项目和工具看起，链接尽量都指向官网、文档或公开仓库，方便你继续深入。",
      ...
      ctaBody: "通过提交页发送项目名称、链接和简短介绍，我们会再人工审核是否收录。",
      ctaButton: "立即提交",
      footerText: "一个用来发现 OpenClaw 项目和生态工具的导航站。",
    },
    about: {
